        ...
        <form method="POST">
            ...
            <center>
                <table cellpadding="4" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td style="font-family: monospace" valign="top">
                            Host &nbsp; &nbsp; : <input type="text" name="src_host"
                                                        value="<?php echo $src_host; ?>"/><br/>
                            User &nbsp; &nbsp; : <input type="text" name="src_user"
                                                        value="<?php echo $src_user; ?>"/><br/>
                            Pass &nbsp; &nbsp; : <input type="password" name="src_pass"
                                                        value="<?php echo $src_pass; ?>"/><br/>
                        ...
                        <td style="font-family: monospace" valign="top">
                            Host &nbsp; &nbsp; : <input type="text" name="dst_host"
                                                        value="<?php echo $dst_host; ?>"/><br/>
                            User &nbsp; &nbsp; : <input type="text" name="dst_user"
                                                        value="<?php echo $dst_user; ?>"/><br/>
                            Pass &nbsp; &nbsp; : <input type="password" name="dst_pass"
                                                        value="<?php echo $dst_pass; ?>"/><br/>
                ...
                <div style="text-align:left;width:300px">
                    <br/>
                    <input type="radio" name="user_mode" value="1" onclick="hD(gE('user_context'))" checked="checked"/>
                    Assign tasks to
                    <?php $objMemberList->qSelect('user_list', 'username', '', '- nobody -'); ?><br/>
                    <input type="radio" name="user_mode" value="2" onclick="sD(gE('user_context'))"/> Auto assign tasks
                    from context field
                    <div id="user_context"
                         style="margin:0px 0px 0px 25px;padding:5px;background-color:#fcfcfc;display:none">
                        <table cellpadding="2" cellspacing="0" border="0">
                            ...
                            while ($objMember = $objMemberList->rNext()) {
                                ?>
                                <tr>
                                    <td><input type="text" name="user_context[<?php echo $objMember->id; ?>]"
                                               style="width:90px"></td>
                                    <td>-&gt;</td>
