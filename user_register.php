...
<div align="center">
    <div id="horiz">
        <p align="center"><img src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/freak-logo.png" border="0"
                               alt="TaskFreak!"/></p>
        <?php
        if ($pDude) {
            ...
            <form action="user_register.php" method="post">
                ...
                ?><br/>
                <p align="center">
                    <input type="submit" name="submit" value="<?php echo $langButton['add_account']; ?>"/> &nbsp; <input
                            type="reset" value="<?php echo $langButton['reset']; ?>"/>
                </p>
                <p>&nbsp;</p>
            </form>
            <?php
