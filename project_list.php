...
// order
$objItemList->addOrder('projectStatus_statusKey ASC, name ASC');
        ...
        <tr align="left">
            ...
            <th width="10%" class="act"><?php
                if ($objUser->checkLevel(7)) {
                    ?><a href="project_edit.php?"><img src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/b_new.png"
        ...
        if ($objItemList->rMore()) {
            while ($objItem = $objItemList->rNext()) {
                ...
                <tr<?php echo $rowStyle; ?>>
                    ...
                    <td align="center">
                        <a href="project_edit.php?id=<?php echo $objItem->id; ?>"><img
                        ...
                        if ($objItem->memberProject->checkRights(14) || ($objUser->checkLevel(9))) {
                            ...
                            <a href="<?php echo Tzn::concatUrl($pLink, 'delete=' . $objItem->id); ?>"
                               onclick="return confirm('<?php echo $langMessage['project_delete_confirm']; ?>');"
                               title="<?php echo $langMessage['project_delete']; ?>"><img
                                        src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/b_dele.png" width="20"
                                        height="16" border="0" alt="<?php echo $langMessage['project_delete']; ?>"/></a>
                            <?php
                        } else {
                            ?>
                            <img src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/b_deln.png" width="20" height="16"
                                 border="0" alt="<?php echo $langMessage['project_delete']; ?>"
                                 title="<?php echo $langMessage['project_delete_no']; ?>"" />
                            <?php
                        }
                        ?>
                    </td>
