...
$GLOBALS["langTznCommon"] = array(
    'form_error' => 'Gre�ka u formi - Informacije nisu spremljene!',
...
$GLOBALS["langTznUser"] = array(
    ...
    "user_pass_empty" => "lozinka nemo�e biti prazna",
    ...
    "common_date_invalid" => "datum zavr�etka je krivi",
    ...
    "button_delete" => "izbri�i",
    "button_login" => "ulaz",
    "profile_update_success" => "racun uspje�no izmjenjen",
    "url" => "stranica &nbsp;:&nbsp;",
    "atsign" => "(od)"
);
