...
if (@constant('PRJ_REGISTRATION')) {
    ?>
    <p><b>Se voc&ecirc; n&atilde; for um membro</b> mas voc&ecirc; quer se tornar um, <a href="user_register.php">clique
            aqui para requisitar uma conta de usu&aacute;rio</a>.</p>
    <?php
}
?>
