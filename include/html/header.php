...
<head>
    <title>TaskFreak!<?php if ($pPageTitle) {
            echo ' ' . $pPageTitle;
        } ?></title>
    ...
    <link rel="stylesheet" type="text/css"
          href="skins/<?php echo FRK_SKIN_FOLDER; ?>/css/priority<?php echo FRK_PRIORITY_LEVELS; ?>.css"/>
    <?php
    if ($pUserIsLogged) {
        ?>
    ...
    if ($pJScalendar) {
        ...
        <script type="text/javascript"
                src="jscalendar/lang/calendar-<?php echo ($langParams['jscalendar']) ? $langParams['jscalendar'] : 'en'; ?>.js"></script>
        <script type="text/javascript"
                src="jscalendar/calendar-setup.php?format=<?php echo rawurlencode(TZN_DATE_FRM); ?>"></script>
        <?php
    ...
    if ($pCss) {
        ...
        foreach ($arrJs as $value) {
            ?>
            <link rel="stylesheet" type="text/css"
                  href="skins/<?php echo FRK_SKIN_FOLDER; ?>/css/<?php echo $value; ?>"/>
            <?php
        }
    }
    ?>
    ...
    if ($pUserIsLogged && @constant('FRK_RSS_SIZE') > 0) {
        ...
        <link rel="alternate" type="application/rss+xml" title="RSS Feed"
              href="<?php echo PRJ_WWW_URL; ?>rss.php?user=<?php echo $objUser->username; ?>&amp;c=<?php echo $objUser->getRssCode(); ?>"/>
        <?php
    }
    ?>
</head>
...
if ($pUserIsLogged) {
    ...
    <div id="header">
        <form name="zappa" action="index.php" method="post" id="zappa">
            ...
            <div id="header1">
                <div id="userlogout"><a href="logout.php" title="<?php echo $langMenu['logout']; ?>"><img
                                id="frk-logout" src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/logout-off.png"
                                width="13" height="13" border="0"
                                onmouseover="this.src='skins/<?php echo FRK_SKIN_FOLDER; ?>/images/logout-on.png'"
                                onmouseout="this.src='skins/<?php echo FRK_SKIN_FOLDER; ?>/images/logout-off.png'"/></a>
                </div>
                <div id="user">
                    <div id="username"><a
                                href="user_edit.php?id=<?php echo $objUser->id; ?>"><?php echo $objUser->getName(); ?></a>
                    </div>
                    <div id="userdate"><?php echo strftime(TZN_DATETIME_SHX, time() - TZN_TZSERVER + Tzn::_getUserTZ()); ?></div>
                </div>
                <div><a href="<?php echo $_SESSION['linkItems']; ?>"><img
                                src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/logo.png" width="166" height="30"
                                alt="TaskFreak!" border="0"/></a></div>
            </div>
            <div id="header2">
                <?php
                // -------------- NAV MENU ---------------------------------------------------
                    ...
                    <ul id="nav" class="level0">
                        <li><?php echo $langMenu['task']; ?>
                            <ul class="level1">
                                ...
                                if ($objUser->checkLevel(11)) {
                                    ?>
                                    <li><a href="javascript:freak_new()"
                                           accesskey="n"><?php echo $langMenu['new_todo']; ?></a></li>
                                    <?php
                                }
                                ?>
                        ...
                        <li><?php echo $langMenu['view']; ?>
                            <ul id="nav_projects" class="level1">
                                <li class="more"><a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=today'); ?>"
                                                    accesskey="l"><?php echo $langMenu['all_projects']; ?></a>
                                    <ul>
                                        <li><a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=future'); ?>"
                                               accesskey="f"><?php echo $langMenu['future_tasks']; ?></a></li>
                                        <li><a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=past'); ?>"
                                               accesskey="p"><?php echo $langMenu['past_tasks']; ?></a></li>
                                        <li><a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=all'); ?>"
                                               accesskey="a"><?php echo $langMenu['all_tasks']; ?></a></li>
                                    </ul>
                                </li>
                                <?php
                                while ($objProj = $objUserProjectList->rNext()) {
                                    ...
                                    ?>
                                    <li class="more"><a
                                                href="<?php echo Tzn::concatUrl($pTmpLink, 'show=today'); ?>"><?php $objProj->p('name'); ?></a>
                                        <ul class="level2">
                                            <li>
                                                <a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=future') ?>"><?php echo $langMenu['future_tasks']; ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=past') ?>"><?php echo $langMenu['past_tasks']; ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo Tzn::concatUrl($pTmpLink, 'show=all') ?>"><?php echo $langMenu['all_tasks']; ?></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <?php
                        ...
                        <li><?php echo $langMenu['manage']; ?>
                            <ul class="level1">
                                ...
                                ?>
                                <li>
                                    <a href="user_edit.php?id=<?php echo $objUser->id; ?>"><?php echo $langMenu['preferences']; ?></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div id="rightmenu">
                    ...
                    ?>
                    <a id="lnkRefresh" href="<?php echo $_SESSION['linkItems']; ?>"
                       title="<?php echo $langMenu['reload']; ?>"><img id="frk_status"
                                                                       src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/loading.gif"
