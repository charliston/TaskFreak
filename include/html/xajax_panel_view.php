<div id="fviewmenu">
    <div id="fviewclose"><a href="javascript:freak_view(0)"><?php echo $GLOBALS['langForm']['close']; ?><img
                    src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/b_disn.png" width="20" height="16" border="0"
                    alt="close"/></a></div>
    <div id="fviewedit"><a
                href="javascript:freak_edit(ff.elements['id'].value)"><?php echo $GLOBALS['langForm']['edit']; ?><img
                    src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/b_edin.png" width="20" height="16" border="0"
                    alt="edit"/></a></div>
    <div id="fviewdelete"><a href="javascript:freak_del(ff.elements['id'].value)"
                             onClick="return confirm('<?php echo $GLOBALS['langMessage']['task_delete_confirm']; ?>')"><?php echo $GLOBALS['langForm']['delete']; ?>
...
<div class="tabmenu">
    <ul>
        <li id="tdesc" class="active"><a
                    href="javascript:freak_more('desc')"><?php echo $GLOBALS['langTaskDetails']['tab_description']; ?></a>
        </li>
        <li id="tcomm"><a
                    href="javascript:freak_more('comm')"><?php echo $GLOBALS['langTaskDetails']['tab_comments']; ?></a>
        </li>
        <li id="tfile"><a href="javascript:freak_more('file')" onclick="this.blur()">files</a></li>
        <li id="thist"><a
                    href="javascript:freak_more('hist')"><?php echo $GLOBALS['langTaskDetails']['tab_history']; ?></a>
        </li>
    </ul>
</div>
<div class="tabcontent">
    <div id="vedit">
        ...
        <div>
            ...
            <input type="button" name="veditcancel" value="<?php echo $GLOBALS['langForm']['cancel']; ?>"
                   onClick="freak_body_edit()">
        </div>
    </div>
    <div id="vmore"></div>
