    ...
    function connect()
    {
        if (!$this->_dbLink) {
            if (@constant('TZN_DB_PERMANENT')) {
                $this->_dbLink = @mysqli_connect("p:" . $this->_dbHost, $this->_dbUser, $this->_dbPass);
            } else {
                $this->_dbLink = @mysqli_connect($this->_dbHost, $this->_dbUser, $this->_dbPass);
            }
            if (!$this->_dbLink) {
                if (!$this->_critical) {
