...
define('TZN_DB_PASS', 'root');  // edit here
define('TZN_DB_BASE', 'task');  // edit here
...
define('FRK_VERSION', '0.7.3');
define('FRK_VERSION_RELEASE', '2019-02-27');
...
define('FRK_DEFAULT_LANGUAGE', 'pt');    // en, fr, it, de, nl, da, zh, pl
// TaskFreak! skin
